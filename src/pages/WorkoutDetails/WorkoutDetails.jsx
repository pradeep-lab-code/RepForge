...
const WorkoutDetails = () => {
  ...
  const allWorkouts = [...recommendedWorkouts, ...popularWorkouts ,...savedWorkouts];

  const workout = allWorkouts.find((item) => item.id === Number(id));


  if (!workout) {
    return <div className="text-white p-10">Workout Not Found</div>;
  }
